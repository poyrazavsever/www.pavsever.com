...
function SkillCard({link = "", iconName = "", iconType = "", iconColor = "", skillName = ""}) {
  return (
    <a href={link} target='_blank' without="true" rel="noreferrer" className='inline-flex items-center justify-center gap-2 px-4 py-2 border w-32 md:w-36 border-neutral-800 bg-neutral-950 group hover:border-neutral-600 transition-all'>
